...
<body>
	...
	<div class="apropos_container">
		...
		<div class="apropos_tech apropos_margin">
			...
			back-end, nous avons utilisé Java et son framework SPRING, pour gérer
			efficacement les données et assurer une communication sécurisée. Côté
			front-end, nous avons exploité nos services avec Javascript et son
			framework ANGULAR pour créer une expérience utilisateur réactive et
			attrayante.
		</div>
		...
		<div class="apropos_resultat apropos_margin">
			...
			Il a été une opportunité d'apprendre, de s'organiser et de travailler
			en équipe, de surmonter des obstacles et de s'aguerrir en tant que
		...
		savoir plus sur notre projet, n'hésitez pas à nous contacter à
		l'adresse suivante : tcl.m2iformation@gmail.com.

		<div>Nous vous remercions de prendre le temps de découvrir notre
			travail et sommes impatients de partager avec vous, notre aventure de
			développement. Cordialement, Abigaël, Lauriane, Rodrigue.</div>
